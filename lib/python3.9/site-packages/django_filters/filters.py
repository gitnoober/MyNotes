...
class MultipleChoiceFilter(Filter):
    ...
    def is_noop(self, qs, value):
        ...
        if self.extra.get("required") and len(value) == len(
            self.field.choices
        ):
            return True
...
class AllValuesFilter(ChoiceFilter):
    ...
    def field(self):
        ...
        qs = qs.order_by(self.field_name).values_list(
...
class LookupChoiceFilter(Filter):
    ...
    * ``field_class`` is an optional argument that allows you to set the inner
    ...
    def __init__(
        ...
        super(LookupChoiceFilter, self).__init__(
    ...
    * ``field_labels`` is an optional argument that allows you to customize
    ...
    def build_choices(self, fields, labels):
        ...
        descending = [
            (
                "-%s" % param,
                labels.get("-%s" % param, self.descending_fmt % label),
            )
