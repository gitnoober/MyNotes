...
class FootnoteExtension(Extension):
    ...
    def extendMarkdown(self, md):
        ...
        md.parser.blockprocessors.register(
            FootnoteBlockProcessor(self), "footnote", 17
        )
    ...
    def makeFootnoteRefId(self, id, found=False):
        ...
        if self.getConfig("UNIQUE_IDS"):
            return self.unique_ref(
                "fnref%s%d-%s"
                % (self.get_separator(), self.unique_prefix, id),
                found,
            )
        else:
            return self.unique_ref(
                "fnref{}{}".format(self.get_separator(), id), found
            )
    ...
    def run(self, parent, blocks):
        ...
        if m:
            ...
            if m2:
                ...
                fn_blocks[0] = "\n".join(
                    [fn_blocks[0], self.detab(therest)]
                ).strip("\n")
