...
LANGUAGES = {
    ...
    "Belarusian": Language(
        ...
        alphabet=(
            ...
            "абвгдеёжзійклмнопрстуўфхцчшыьэюяʼ"
        ),
    ...
    "Hungarian": Language(
        ...
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=(
            "abcdefghijklmnoprstuvzáéíóöőúüű" "ABCDEFGHIJKLMNOPRSTUVZÁÉÍÓÖŐÚÜŰ"
        ),
    ...
    "Macedonian": Language(
        ...
        alphabet=(
            "АБВГДЃЕЖЗЅИЈКЛЉМНЊОПРСТЌУФХЦЧЏШ" "абвгдѓежзѕијклљмнњопрстќуфхцчџш"
        ),
